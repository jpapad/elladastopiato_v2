  ...
  return (
    <footer className="bg-white dark:bg-[#050505] border-t border-black/5 dark:border-white/5 pt-24 pb-12 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-24">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter leading-tight max-w-md opacity-80">
              Η παράδοση συναντά την <span className="italic font-black">ψηφιακή εποχή.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10">
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-sm font-medium text-black/40 dark:text-white/40">
                <li><Link href="/" className="hover:text-orange-500 transition-colors">Αρχική</Link></li>
                <li><Link href="/recipes" className="hover:text-orange-500 transition-colors">Συνταγές</Link></li>
                <li><Link href="/regions" className="hover:text-orange-500 transition-colors">Περιοχές</Link></li>
              </ul>
            </div>
            <div className="space-y-6">
            ...
            <div className="space-y-6 hidden md:block">
              ...
              <Link href="/admin" className="inline-flex items-center gap-2 text-sm font-medium text-black/40 dark:text-white/40 hover:text-orange-500 transition-colors">
        ...
        {/* Marquee */}
        <div className="relative py-10 border-y border-black/5 dark:border-white/5 group">
          <div className="flex whitespace-nowrap overflow-hidden py-4 opacity-[0.04] pointer-events-none select-none">
        ...
        {/* Bottom */}
        <div className="mt-12 flex flex-col md:row items-center justify-between gap-8 pt-8 border-t border-black/5 dark:border-white/5">
          <p className="text-[10px] text-black/20 dark:text-white/20 uppercase tracking-[0.2em] font-bold">
            © 2026 ΕΛΛΑΔΑ ΣΤΟ ΠΙΑΤΟ. ALL RIGHTS RESERVED.
          </p>

          <button
            onClick={scrollToTop}
            className="group flex items-center gap-4 bg-black/5 dark:bg-white/5 px-6 py-3 rounded-full border border-black/10 dark:border-white/10 hover:border-orange-500/50 transition-all duration-500"
          >
            <span className="text-[10px] font-black uppercase tracking-widest text-black/40 dark:text-white/40 group-hover:text-orange-500 transition-colors">
